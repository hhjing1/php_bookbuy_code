...
$username=$_SESSION['val'];
 ...
 //查询其他两个表显示全部的订单信息
        ...
        $sqlbook = "select * from book  where id='".$prodid."' order by id";
...
<div class="main-w3layouts wrapper">
    ...
    <div class="main-agileinfo">
        <div class="agileits-top" >
            <form method="post" action="../actionphp/addorder.php">
                ...
                <h3 id="wen2"> 购买数量</h3><input type="text" class="text" name="shuliang" placeholder="" required="" value="<?php echo $geshu ?>">
