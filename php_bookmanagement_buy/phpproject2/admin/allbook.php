...
<table class="table table-hover table-striped table-bordered table-sm" id="resultshow">
    ...
    while ($rows = mysqli_fetch_row($result)) {
        echo "<tr>";
        echo"<td height='50' width='50' rowspan='5' align='center'><img src=" . $rows[5] . " height='200' width='200'></td>";
        ...
        echo "<td height='25' align='center'>" . $rows[4] . "&nbsp; &nbsp;个</td></tr><tr>";
        echo "<td align='center' height='25'width='150'>
               相关操作
              </td><td  align='center'>
              <a href=updatabook.php?action=update&id=" . $rows[0] . ">修改</a>
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              <a href=deletebook.php?action=del&id=" . $rows[0] . " onclick = 'return del();'>删除</a>
              </td>";
        echo "</tr>";
    }
    ?>
