    ...
    <div class="main-agileinfo">
        <div class="agileits-top">
            <form method="post" action="updatabookorder_ok.php">
                客户地址<input type="text" class="text" name="address" placeholder="" required="" value="<?php echo $rows[3] ?>">
                当前订单状态<input type="text" class="text" name="state" placeholder="" required=""  value="<?php echo $rows[6] ?>">
